...
def validate_snapshots(snapshot_list_file):
    ...
    # Create and display two separate tables for valid and invalid snapshots
    ...
    console.print(Panel(Group(valid_table, invalid_table), expand=False, border_style="green"))
